...
#if 0
struct BDG_MIPIDSI2_REGS {
	struct DEVICE_VERSION_OS_REG DEVICE_VERSION_OS;		/* 0000 */
	struct DEVICE_SOFT_RSTN_OS_REG DEVICE_SOFT_RSTN_OS;	/* 0004 */
	struct DEVICE_N_LANES_OS_REG DEVICE_N_LANES_OS;		/* 0008 */
	struct DEVICE_INT_ST_MAIN_OS_REG_REG DEVICE_INT_ST_MAIN_OS;	/* 000C */
	struct DEVICE_EOTP_CFG_OS_REG_REG DEVICE_EOTP_CFG_OS;		/* 0010 */
	struct DEVICE_CTRL_CFG_OS_REG_REG DEVICE_CTRL_CFG_OS;		/* 0014 */

	struct DEVICE_FIFO_STATUS_OS_REG_REG DEVICE_FIFO_STATUS_OS;	/* 0020 */

	struct DEVICE_PHY_SHUTDOWNZ_OS_REG_REG DEVICE_PHY_SHUTDOWNZ_OS;	/* 0100 */
	struct DEVICE_PHY_RSTZ_OS_REG_REG DEVICE_PHY_RSTZ_OS;	/* 0104 */
	struct DEVICE_PHY_CAL_OS_REG_REG DEVICE_PHY_CAL_OS;	/* 0108 */
	struct DEVICE_PHY_MODE_OS_REG_REG DEVICE_PHY_MODE_OS;	/* 010C */

	struct DEVICE_PHY_TEST_SEL_OS_REG_REG DEVICE_PHY_TEST_SEL_OS;	/* 0114 */
	struct DEVICE_PHY_TEST_CTRL0_OS_REG_REG DEVICE_PHY_TEST_CTRL0_OS;	/* 0118 */
	struct DEVICE_PHY_TEST_CTRL1_OS_REG_REG DEVICE_PHY_TEST_CTRL1_OS;	/* 011C */
	struct DEVICE_PHY_CLK_STATUS_OS_REG_REG DEVICE_PHY_CLK_STATUS_OS;	/* 0120 */
	struct DEVICE_PHY_DATA_STATUS_OS_REG_REG DEVICE_PHY_DATA_STATUS_OS;	/* 0124 */

	struct DEVICE_LPTXRDY_TO_CNT_OS_REG_REG DEVICE_LPTXRDY_TO_CNT_OS;	/* 0140 */
	struct DEVICE_LPTX_TO_CNT_OS_REG_REG DEVICE_LPTX_TO_CNT_OS;	/* 0144 */
	struct DEVICE_HSRX_TO_CNT_OS_REG_REG DEVICE_HSRX_TO_CNT_OS;	/* 0148 */

	struct DEVICE_INT_ST_PHY_FATAL_OS_REG_REG DEVICE_INT_ST_PHY_FATAL_OS;	/* 0200 */
	struct DEVICE_INT_MASK_N_PHY_FATAL_OS_REG_REG DEVICE_INT_MASK_N_PHY_FATAL_OS;	/* 0204 */
	struct DEVICE_INT_FORCE_PHY_FATAL_OS_REG_REG DEVICE_INT_FORCE_PHY_FATAL_OS;	/* 0208 */

	struct DEVICE_INT_ST_PHY_OS_REG_REG DEVICE_INT_ST_PHY_OS;	/* 0210 */
	struct DEVICE_INT_MASK_N_PHY_OS_REG_REG DEVICE_INT_MASK_N_PHY_OS;	/* 0214 */
	struct DEVICE_INT_FORCE_PHY_OS_REG_REG DEVICE_INT_FORCE_PHY_OS;	/* 0218 */

	struct DEVICE_INT_ST_DSI_FATAL_OS_REG_REG DEVICE_INT_ST_DSI_FATAL_OS;	/* 0220 */
	struct DEVICE_INT_MASK_N_DSI_FATAL_OS_REG_REG DEVICE_INT_MASK_N_DSI_FATAL_OS;	/* 0224 */
	struct DEVICE_INT_FORCE_DSI_FATAL_OS_REG_REG DEVICE_INT_FORCE_DSI_FATAL_OS;	/* 0228 */

	struct DEVICE_INT_ST_DSI_OS_REG_REG DEVICE_INT_ST_DSI_OS;	/* 0230 */
	struct DEVICE_INT_MASK_N_DSI_OS_REG_REG DEVICE_INT_MASK_N_DSI_OS;	/* 0234 */
	struct DEVICE_INT_FORCE_DSI_OS_REG_REG DEVICE_INT_FORCE_DSI_OS;	/* 0238 */

	struct DEVICE_INT_ST_IPI_FATAL_OS_REG_REG DEVICE_INT_ST_IPI_FATAL_OS;	/* 0260 */
	struct DEVICE_INT_MASK_N_IPI_FATAL_OS_REG_REG DEVICE_INT_MASK_N_IPI_FATAL_OS;	/* 0264 */
	struct DEVICE_INT_FORCE_IPI_FATAL_OS_REG DEVICE_INT_FORCE_IPI_FATAL_OS;	/* 0268 */

	struct DEVICE_INT_ST_FIFO_FATAL_OS_REG DEVICE_INT_ST_FIFO_FATAL_OS;	/* 0280 */
	struct DEVICE_INT_MASK_N_FIFO_FATAL_OS_REG DEVICE_INT_MASK_N_FIFO_FATAL_OS;	/* 0284 */
	struct DEVICE_INT_FORCE_FIFO_FATAL_OS_REG DEVICE_INT_FORCE_FIFO_FATAL_OS;	/* 0288 */

	struct DEVICE_INT_ST_RX_TRIGGERS_OS_REG DEVICE_INT_ST_RX_TRIGGERS_OS;	/* 02D0 */
	struct DEVICE_INT_MASK_N_RX_TRIGGERS_OS_REG DEVICE_INT_MASK_N_RX_TRIGGERS_OS;	/* 02D4 */
	struct DEVICE_INT_FORCE_RX_TRIGGERS_OS_REG DEVICE_INT_FORCE_RX_TRIGGERS_OS;	/* 02D8 */

	struct DEVICE_IPI_MODE_CFG_OS_REG DEVICE_IPI_MODE_CFG_OS;	/* 0400 */
	struct DEVICE_IPI_VALID_VC_CFG_OS_REG DEVICE_IPI_VALID_VC_CFG_OS;	/* 0404 */
	struct DEVICE_IPI_TX_DELAY_OS_REG DEVICE_IPI_TX_DELAY_OS;	/* 0408 */
